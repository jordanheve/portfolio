...
export default function Projects() {
  ...
  return (
    <section id="projects" className="max-w-screen-2xl text-center  mx-auto w-full " >
      <h3 className="dark:text-teal-400 text-6xl  mb-10 font-semibold text-slate-600">
        {t("Projects")}
      </h3>
      {/**Projects maping */}
      <div className="grid xl:grid-cols-2  2xl:grid-cols-3 gap-y-12 place-items-center ">
        {projectsData.map((item) => (
          <div
            key={item.id}
            className=" max-w-sm min-h-full border-2 border-zinc-400 dark:border-zinc-600"
          >
            <div className=" relative overflow-hidden group h-[192px]">
            ...
            <div className="py-4 px-4 flex flex-col  justify-between min-h-[192px]">
              <h6 className=" dark:text-teal-400 font-semibold text-xl">
              ...
              <div className="flex justify-between">
                <div className=" flex items-center gap-3">
                  ...
                  <a title="Github" aria-labelledby="Github repo website" href={item.repo} className="text-2xl dark:text-teal-400 dark:hover:text-teal-200">
        ...
        {/**More projects */}
        <div className="  w-96 h-96 border-2 border-zinc-400 dark:border-zinc-600">
          ...
          {t("More Projects")}
          <br/>
          <span className="dark:text-teal-400 font-semibold">
          Frontend Mentor
          </span>
          </h6>
          <div >
