...
const resources = {
  en: {
    translation: {
      ...
      "Audiophile E-commerce": "E-commerce website that allows users to browse products and categories, manage their cart while ensuring the cart state is preserved even after refreshing the page, and complete purchases with checkout validation",
  ...
  es: {
    translation: {
      ...
      "Audiophile E-commerce": "Tienda en linea que permite a los usuarios navegar por productos y categorías, gestionar su carrito asegurando que el estado del carrito se preserve incluso después de actualizar la página, y completar compras con validación en el formulario de pago.",
